package com.hit.haircutappointments.Classes;
...
public class RecyclerTouchHelper extends ItemTouchHelper.SimpleCallback {
    ...
    public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
        if (viewHolder != null) {
            final View foregroundView = ((ComingAndPassedAdapter.MyViewHolder) viewHolder).viewForeground;
    ...
    public void onChildDrawOver(Canvas c, RecyclerView recyclerView,
        ...
        final View foregroundView = ((ComingAndPassedAdapter.MyViewHolder) viewHolder).viewBackground;
